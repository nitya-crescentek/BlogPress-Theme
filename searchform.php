...
<form method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		<span class="screen-reader-text"><?php echo _x( 'Search for:', 'label', 'blogpress' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
	...
	printf(
		...
		blogpress_get_svg_icon( 'search' ) // phpcs:ignore -- Escaping not necessary here.
	);
